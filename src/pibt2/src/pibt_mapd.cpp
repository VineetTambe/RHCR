...
void PIBT_MAPD::run()
{
  ...
  {
    grid_pathfinding::Nodes targets(P->getNum(), nullptr);
...
{
  // compare two nodes
  auto compare = [&](grid_pathfinding::Node* const v, grid_pathfinding::Node* const u) {
  ...
  // get candidates
  grid_pathfinding::Nodes C = ai->v_now->neighbor;
