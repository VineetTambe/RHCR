...
public:
  ...
  grid_pathfinding::Node* get(const int t, const int i) const;

  // path
  grid_pathfinding::Path getPath(const int i) const;
  ...
  // last configuration
  grid_pathfinding::Node* last(const int i) const;
  ...
  int getMaxConstraintTime(const int id, grid_pathfinding::Node* s, grid_pathfinding::Node* g, grid_pathfinding::Graph* G) const;
